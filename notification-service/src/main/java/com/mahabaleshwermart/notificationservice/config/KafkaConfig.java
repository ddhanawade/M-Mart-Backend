 ...
 * Configures Kafka consumers for order notification events
 */
@Configuration
@EnableKafka
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.mahabaleshwermart.common.events");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.mahabaleshwermart.common.events.OrderNotificationEvent");
